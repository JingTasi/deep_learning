...
class SoftmaxRegression:
    ...
    def construct_graph(self):
        ...
        self.x1 = self.fully_connected(self.x, self.w1, 0, batch_norm=True, activation=True, dropout=True)
        ...
        self.x2 = self.fully_connected(self.x1, self.w2, 0, batch_norm=True, activation=True, dropout=True)
        ...
        self.logits = tf.identity(self.fully_connected(self.x2, self.w3, 0, batch_norm=False, activation=False, dropout=False), name='logits')
    ...
    def fully_connected(self, x, w, b, batch_norm=True, activation=True, dropout=True):
        y = tf.matmul(x, w) + b
        if batch_norm:
