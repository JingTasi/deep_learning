...
class SoftmaxRegression:
    ...
    def construct_graph(self):
        ...
        self.x1 = self.fully_connected(self.x, self.w1, self.b1, batch_norm=True, activation=True, dropout=False)
        ...
        self.x2 = self.fully_connected(self.x1, self.w2, self.b2, batch_norm=True, activation=True, dropout=False)
    ...
    def fully_connected(self, x, w, b, batch_norm=True, activation=True, dropout=False):
        y = tf.matmul(x, w) + b
        if batch_norm:
