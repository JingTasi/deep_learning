...
class SoftmaxRegression:
    ...
    def construct_graph(self):
        ...
        self.x1 = self.fully_connected(self.x, self.w1, self.b1, batch_norm=True, activation=True, dropout=True)
        ...
        self.x2 = self.fully_connected(self.x1, self.w2, self.b2, batch_norm=True, activation=True, dropout=True)
